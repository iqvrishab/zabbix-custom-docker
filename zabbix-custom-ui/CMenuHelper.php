			...
			$menu->add(
				(new CMenuItem(_('Dashboards')))
					...
					->setAliases(['dashboard.list'])
                        ...
                        $menu->add(
                                (new CMenuItem(_('Log Management')))
                                        ->setIcon(ZBX_ICON_DASHBOARDS)
                                        ->setUrl(new CUrl('http://log.identiqalabs.com'))
                                        ->setTarget('_blank')
                        );
                        $menu->add(
                                (new CMenuItem(_('Configuration  Management')))
                                        ->setIcon(ZBX_ICON_DASHBOARDS)
                                        ->setUrl(new CUrl('http://config.identiqalabs.com'))
                                        ->setTarget('_blank')
                        );
		}
